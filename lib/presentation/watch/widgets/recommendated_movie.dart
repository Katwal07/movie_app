...
class RecommendatedMovie extends StatelessWidget {
  const RecommendatedMovie({super.key, required this.movieId});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => GenericCubit()..execute(sl<GetRecommendatedMovieUseCase>(),params: movieId),
      child: Column(
